...
# Ports (matching ChatQnA working ports)
...
export AGENTQNA_BACKEND_SERVICE_ENDPOINT="http://localhost:${AGENTQNA_VLLM_SERVICE_PORT}/v1/agentqna"

# Agent/LLM Parameters
export temperature=0.7
export max_new_tokens=256
export recursion_limit_worker=5
export recursion_limit_supervisor=5
export db_name="Chinook"
export db_path="/home/user/chinook-db/Chinook_Sqlite.sqlite"

# External Service URLs
export CRAG_SERVER="http://localhost:8080"
export WORKER_AGENT_URL="http://localhost:7001/v1/chat/completions"
export SQL_AGENT_URL="http://localhost:7002/v1/chat/completions"
